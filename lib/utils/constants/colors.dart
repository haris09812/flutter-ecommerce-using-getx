...
class TColors {
  // App theme colors
  static const Color primary = Color(0xFF7A531A);
  static const Color secondary = Color(0xFFEDD800);
  static const Color secondaryLight = Color(0xC9346DAE);
  static const Color primaryBackground = Color(0xFFB88A3C); // Primary Color Background
  ...
  // Icon colors
  static const Color iconPrimaryLight = Color(0xFFB88A3C); // Theme Nightingale Gray 80
  static const Color iconSecondaryLight = Color(0xFF9CA3AF); // Theme Nightingale Gray 40
  static const Color iconPrimaryDark = Color(0xFF7A531A); // Theme Nightingale Gray White
